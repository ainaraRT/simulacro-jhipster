...
public class VueloCriteria implements Serializable, Criteria {
    ...
    private LongFilter tripulantesId;
    ...
    public VueloCriteria(VueloCriteria other) {
        ...
        this.tripulantesId = other.tripulantesId == null ? null : other.tripulantesId.copy();
    ...
    public LongFilter getTripulantesId() {
        return tripulantesId;
    }

    public LongFilter tripulantesId() {
        if (tripulantesId == null) {
            tripulantesId = new LongFilter();
        }
        return tripulantesId;
    }

    public void setTripulantesId(LongFilter tripulantesId) {
        this.tripulantesId = tripulantesId;
    }
    ...
    public boolean equals(Object o) {
        ...
        return (
            ...
            Objects.equals(tripulantesId, that.tripulantesId) &&
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, pasaporteCovid, numeroDeVuelo, origenId, destinoId, avionId, pilotoId, tripulantesId, distinct);
    }
    ...
    public String toString() {
        return "VueloCriteria{" +
            ...
            (tripulantesId != null ? "tripulantesId=" + tripulantesId + ", " : "") +
