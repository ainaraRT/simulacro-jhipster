...
export class TripulanteUpdateComponent implements OnInit {
  ...
  editForm = this.fb.group({
    ...
    apelidos: [null, [Validators.required, Validators.minLength(10), Validators.maxLength(255)]],
  ...
  protected createFromForm(): ITripulante {
    return {
      ...
      apelidos: this.editForm.get(['apelidos'])!.value,
