...
class TripulanteResourceIT {
    ...
    private static final String DEFAULT_APELIDOS = "AAAAAAAAAA";
    private static final String UPDATED_APELIDOS = "BBBBBBBBBB";
    ...
    void createTripulante() throws Exception {
        ...
        assertThat(testTripulante.getApelidos()).isEqualTo(DEFAULT_APELIDOS);
    ...
    @Test
    @Transactional
    void checkApelidosIsRequired() throws Exception {
        int databaseSizeBeforeTest = tripulanteRepository.findAll().size();
        // set the field null
        tripulante.setApelidos(null);
    ...
    void getAllTripulantes() throws Exception {
        ...
        restTripulanteMockMvc
            ...
            .andExpect(jsonPath("$.[*].apelidos").value(hasItem(DEFAULT_APELIDOS)))
    ...
    void getTripulante() throws Exception {
        ...
        restTripulanteMockMvc
            ...
            .andExpect(jsonPath("$.apelidos").value(DEFAULT_APELIDOS))
    ...
    @Test
    @Transactional
    void getAllTripulantesByApelidosIsEqualToSomething() throws Exception {
        // Initialize the database
        tripulanteRepository.saveAndFlush(tripulante);

        // Get all the tripulanteList where apelidos equals to DEFAULT_APELIDOS
        defaultTripulanteShouldBeFound("apelidos.equals=" + DEFAULT_APELIDOS);

        // Get all the tripulanteList where apelidos equals to UPDATED_APELIDOS
        defaultTripulanteShouldNotBeFound("apelidos.equals=" + UPDATED_APELIDOS);
    }

    @Test
    @Transactional
    void getAllTripulantesByApelidosIsNotEqualToSomething() throws Exception {
        // Initialize the database
        tripulanteRepository.saveAndFlush(tripulante);

        // Get all the tripulanteList where apelidos not equals to DEFAULT_APELIDOS
        defaultTripulanteShouldNotBeFound("apelidos.notEquals=" + DEFAULT_APELIDOS);

        // Get all the tripulanteList where apelidos not equals to UPDATED_APELIDOS
        defaultTripulanteShouldBeFound("apelidos.notEquals=" + UPDATED_APELIDOS);
    }

    @Test
    @Transactional
    void getAllTripulantesByApelidosIsInShouldWork() throws Exception {
        // Initialize the database
        tripulanteRepository.saveAndFlush(tripulante);

        // Get all the tripulanteList where apelidos in DEFAULT_APELIDOS or UPDATED_APELIDOS
        defaultTripulanteShouldBeFound("apelidos.in=" + DEFAULT_APELIDOS + "," + UPDATED_APELIDOS);

        // Get all the tripulanteList where apelidos equals to UPDATED_APELIDOS
        defaultTripulanteShouldNotBeFound("apelidos.in=" + UPDATED_APELIDOS);
    }

    @Test
    @Transactional
    void getAllTripulantesByApelidosIsNullOrNotNull() throws Exception {
        // Initialize the database
        tripulanteRepository.saveAndFlush(tripulante);

        // Get all the tripulanteList where apelidos is not null
        defaultTripulanteShouldBeFound("apelidos.specified=true");

        // Get all the tripulanteList where apelidos is null
        defaultTripulanteShouldNotBeFound("apelidos.specified=false");
    }

    @Test
    @Transactional
    void getAllTripulantesByApelidosContainsSomething() throws Exception {
        // Initialize the database
        tripulanteRepository.saveAndFlush(tripulante);

        // Get all the tripulanteList where apelidos contains DEFAULT_APELIDOS
        defaultTripulanteShouldBeFound("apelidos.contains=" + DEFAULT_APELIDOS);

        // Get all the tripulanteList where apelidos contains UPDATED_APELIDOS
        defaultTripulanteShouldNotBeFound("apelidos.contains=" + UPDATED_APELIDOS);
    }

    @Test
    @Transactional
    void getAllTripulantesByApelidosNotContainsSomething() throws Exception {
        // Initialize the database
        tripulanteRepository.saveAndFlush(tripulante);

        // Get all the tripulanteList where apelidos does not contain DEFAULT_APELIDOS
        defaultTripulanteShouldNotBeFound("apelidos.doesNotContain=" + DEFAULT_APELIDOS);

        // Get all the tripulanteList where apelidos does not contain UPDATED_APELIDOS
        defaultTripulanteShouldBeFound("apelidos.doesNotContain=" + UPDATED_APELIDOS);
    }
    ...
    void putNewTripulante() throws Exception {
        ...
        assertThat(testTripulante.getApelidos()).isEqualTo(UPDATED_APELIDOS);
